...
1. `processos/regras/REGRAS.md` — documentação legível por humanos
2. `processos/regras/regras.snapshot.json` — estrutura legível por máquinas (Agente de Escala)
...
- processos/regras/REGRAS.md
- processos/regras/regras.snapshot.json
